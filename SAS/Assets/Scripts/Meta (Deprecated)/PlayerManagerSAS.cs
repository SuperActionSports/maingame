...
namespace MultiplayerBasicExample
{
	...
	public class PlayerManagerSAS : MonoBehaviour
	{
		...
		List<FencingInputHandler> players = new List<FencingInputHandler>( maxPlayers );
		...
		FencingInputHandler FindPlayerUsingDevice( InputDevice inputDevice )
		{
		...
		void RemovePlayer( FencingInputHandler player )
		{
