...
using InControl;
	...
	public class PlayerManagerSASTennis : MonoBehaviour
	{
		...
		List<TennisController> players = new List<TennisController>( maxPlayers );
		...
		TennisController FindPlayerUsingDevice( InputDevice inputDevice )
		{
		...
		TennisController CreatePlayer( InputDevice inputDevice )
		{
			if (players.Count < maxPlayers)
			{
				...
				var player = gameObject.GetComponent<TennisController>();
		...
		void RemovePlayer( TennisController player )
		{
